...
bg_zom1 = pygame.image.load('img/bg_zom1.png')
bg_zom1 = pygame.transform.scale(bg_zom1, (160, 300))
bg_zom2 = pygame.image.load('img/bg_zom2.png')
bg_zom2 = pygame.transform.scale(bg_zom2, (160, 300))

#Thêm zombie trong màn hình trò chơi
zom_image = pygame.image.load('img/zombie.png')
...
#Thêm hình ảnh búa
bua_image = pygame.image.load('img/bua.png')
